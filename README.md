...
## What is included
- Prompt/rule-based chatbot for UG support FAQs with confidence scoring and source URL references.
...
## Security posture
- Prevents sensitive data sharing prompts and falls back on low-confidence queries.
